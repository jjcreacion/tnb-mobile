...
export type { CustomInputProps, InputSize } from './Input';
...
export type { TypographyColor, TypographyVariant } from './Typography';

export { Modal } from './Modal';
export type { ModalPosition, ModalSize } from './Modal';
