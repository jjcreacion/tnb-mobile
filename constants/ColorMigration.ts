 ...
 * Mapea colores hardcodeados antiguos a los nuevos tokens del Theme
 */
...
/**
 * Función helper para migrar colores
 * @param color Color hardcodeado antiguo
 * @returns Color del theme correspondiente
 */
...
/**
 * Mapeo de estilos comunes hardcodeados a Theme
 */
